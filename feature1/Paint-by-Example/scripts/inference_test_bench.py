...
def main():
    ...
    test_dataset=COCOImageDataset(test_bench_dir='dataset/test_benchmark/',
                                  id_path="dataset/test_benchmark/test_ids.txt")
    # test_dataset=OpenImageDataset(state="test",
